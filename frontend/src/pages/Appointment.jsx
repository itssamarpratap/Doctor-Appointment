...
const Appointment = () => {
    ...
    // Generate Available Slots with Real-Time Booking
    const getAvailableSlots = async () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            if (i === 0) {
                // If today, ensure next available slot is at least 30 min ahead
            ...
            while (currentDate < endTime) {
                ...
                if (docInfo.slots_booked && docInfo.slots_booked[slotDate]) {
                    ...
                    if (bookedSlots.some(appt => appt.time === slotTime && appt.status === "accepted")) {
